...
#define FILE_EXPORT(payload_e, btl_e) FILE=PSGrooPIC_##payload_e##_##btl_e##.hex
#export (HEX, FILE_EXPORT(PAYLOAD, BOOTLOADER_EXPORT))

#define PAYLOAD_INCLUDE(payload, firmware, payload_dir) <payload_dir##/payload##_pic_##firmware.h>
#include PAYLOAD_INCLUDE(PAYLOAD, FIRMWARE, PAYLOAD_DIR)
...
#define PORT6_DEVICE_OFFSET   PORT5_DEVICE_OFFSET + PORT5_DEVICE_SIZE
...
#define PORT6_CONFIG_OFFSET         PORT5_CONFIG_OFFSET + PORT5_CONFIG_SIZE
